...
class MetricEngine:
    def calculate(
        ...
        return MetricTable(trajectory.frames, trajectory.times, columns, units, metadata, provenance)
    ...
    def _parse_definition(definition: MetricDefinition) -> tuple[str, tuple[str, ...]]:
        ...
        if kind not in {"position", "speed", "acceleration", "angle", "angular_velocity", "symmetry"}:
        ...
        expected = {"position": 1, "speed": 1, "acceleration": 1, "angle": 3, "angular_velocity": 3, "symmetry": 2}[kind]
