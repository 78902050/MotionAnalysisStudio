...
class PipelinePage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        file_actions.addWidget(self.import_config_button)
        ...
        save_actions.addWidget(self.save_config_button)
        save_actions.addWidget(self.reload_config_button)
        save_actions.addStretch(1)
        config_layout.addLayout(save_actions)
